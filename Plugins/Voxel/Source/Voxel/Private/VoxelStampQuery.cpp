	...
	const float Step)
{
	...
	checkVoxelSlow(FVoxelUtilities::AllEqual(Heights.ReinterpretAs<uint32>(), FVoxelUtilities::NaNf_uint));
	...
	const float Step)
{
	...
	checkVoxelSlow(FVoxelUtilities::AllEqual(Distances.ReinterpretAs<uint32>(), FVoxelUtilities::NaNf_uint));
