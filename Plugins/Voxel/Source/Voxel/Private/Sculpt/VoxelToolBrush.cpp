...
void FVoxelCircularBrush::UpdateMaterial(UMaterialInstanceDynamic*& Material) const
{
	VOXEL_FUNCTION_COUNTER();

	UMaterialInterface* TargetMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/Voxel/Tools/MI_ToolCircularBrush.MI_ToolCircularBrush"));
...
void FVoxelAlphaBrush::UpdateMaterial(UMaterialInstanceDynamic*& Material) const
{
	VOXEL_FUNCTION_COUNTER();

	UMaterialInterface* TargetMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/Voxel/Tools/MI_ToolAlphaBrush.MI_ToolAlphaBrush"));
	ensure(TargetMaterial);
...
void FVoxelPatternBrush::UpdateMaterial(UMaterialInstanceDynamic*& Material) const
{
	VOXEL_FUNCTION_COUNTER();

	UMaterialInterface* TargetMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/Voxel/Tools/MI_ToolPatternBrush.MI_ToolPatternBrush"));
	ensure(TargetMaterial);
	...
	const FVector& Tangent) const
{
	switch (BrushType)
	{
	case EVoxelBrushType::Circular: CircularBrushData.UpdateMaterial(Material); break;
	case EVoxelBrushType::Alpha: AlphaBrushData.UpdateMaterial(Material); break;
	case EVoxelBrushType::Pattern: PatternBrushData.UpdateMaterial(Material); break;
	}
