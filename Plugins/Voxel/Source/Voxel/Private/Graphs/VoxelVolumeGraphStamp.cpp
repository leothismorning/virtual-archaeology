...
void FVoxelVolumeGraphStamp::FixupProperties(const IVoxelStampComponentInterface* Interface)
{
...
#if WITH_EDITOR
void FVoxelVolumeGraphStamp::GetActorLabelInfo(FActorLabelInfo& Info) const
{
