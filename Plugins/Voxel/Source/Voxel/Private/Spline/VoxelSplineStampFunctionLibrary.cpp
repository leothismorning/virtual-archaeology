...
FVoxelVectorBuffer UVoxelSplineStampFunctionLibrary::GetSplinePoint(const FVoxelFloatBuffer& SplineKey) const
{
	if (Query.IsPreview())
	{
		return DefaultBuffer;
...
FVoxelFloatBuffer UVoxelSplineStampFunctionLibrary::GetSplineHeight(const FVoxelFloatBuffer& SplineKey) const
{
	return GetSplinePoint(SplineKey).Z;
}
