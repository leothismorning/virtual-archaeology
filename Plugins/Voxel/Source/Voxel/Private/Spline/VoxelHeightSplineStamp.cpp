...
void FVoxelHeightSplineStamp::FixupProperties(const IVoxelStampComponentInterface* Interface)
{
...
#if WITH_EDITOR
void FVoxelHeightSplineStamp::GetActorLabelInfo(FActorLabelInfo& Info) const
{
