...
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FVoxelVertexFactoryGlobalParameters,)
	...
	SHADER_PARAMETER(int32, NumAttributes)
	SHADER_PARAMETER(int32, AttributesIndicesOffset)

	SHADER_PARAMETER_TEXTURE(Texture2D<int>, AttributesIndices_Texture)
	SHADER_PARAMETER(int32, AttributesIndices_TextureSizeLog2)
...
private:
	...
	FTextureRHIRef AttributesIndices_Texture;
