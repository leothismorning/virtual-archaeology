...
FVoxelFuture FVoxelMeshRenderProxy::Initialize_AsyncThread(const FVoxelSubsystem& Subsystem)
{
	VOXEL_FUNCTION_COUNTER();

	MegaMaterialRenderData = FVoxelMegaMaterialRenderUtilities::BuildRenderData(Subsystem.GetConfig().MegaMaterialProxy, Mesh);
	...
	const FVoxelSubsystem& Subsystem)
{
	...
	VertexFactory->RenderData = MegaMaterialRenderData.ToSharedRef();
...
void FVoxelMeshRenderProxy::BuildDistanceField(const FVoxelSubsystem& Subsystem)
{
	VOXEL_FUNCTION_COUNTER();
