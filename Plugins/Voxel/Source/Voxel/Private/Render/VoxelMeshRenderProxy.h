...
public:
	...
	FVoxelFuture Initialize_AsyncThread(const FVoxelSubsystem& Subsystem);
...
private:
	...
	TSharedPtr<const FVoxelMegaMaterialRenderData> MegaMaterialRenderData;
	...
	void BuildDistanceField(const FVoxelSubsystem& Subsystem);
};