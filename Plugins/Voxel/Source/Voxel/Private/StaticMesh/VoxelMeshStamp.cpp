...
void FVoxelMeshStamp::FixupProperties(const IVoxelStampComponentInterface* Interface)
{
...
void FVoxelMeshStamp::GetActorLabelInfo(FActorLabelInfo& Info) const
{
	Info.BlendMode = GetEnumDisplayName(BlendMode).ToString();
	Info.Identifier = NewMesh ? NewMesh->GetName() : "None";
}
#endif
