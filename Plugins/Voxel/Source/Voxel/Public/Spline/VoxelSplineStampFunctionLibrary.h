...
public:
	...
	UFUNCTION(Category = "Stamp|Spline", meta = (AllowList = "HeightSpline, VolumeSpline"))
	FVoxelVectorBuffer GetSplinePoint(UPARAM(meta = (SplineKeyPin)) const FVoxelFloatBuffer& SplineKey) const;

	UFUNCTION(Category = "Stamp|Spline", meta = (AllowList = "HeightSpline, VolumeSpline"))
	FVoxelFloatBuffer GetSplineHeight(UPARAM(meta = (SplineKeyPin)) const FVoxelFloatBuffer& SplineKey) const;
