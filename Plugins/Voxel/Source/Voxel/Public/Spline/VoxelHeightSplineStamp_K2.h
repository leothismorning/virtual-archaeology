...
public:
	...
	static FVoxelHeightSplineStampRef CastToHeightSplineStamp(const FVoxelStampRef Stamp, EVoxelStampCastResult& Result)
	{
	...
	static void MakeCopy(const FVoxelHeightSplineStampRef Stamp, FVoxelHeightSplineStampRef& Copy)
	{
	...
	static void Make(
		...
		UPARAM(meta = (DisplayName = "Graph", ToolTip = "")) UVoxelHeightSplineGraph* Graph,
	...
	UFUNCTION(BlueprintPure, Category = "Voxel|Stamp|Height Spline", DisplayName = "Break Voxel Height Spline Stamp", meta = (Keywords = "Break"))
	static void Break(
	...
	static void GetGraph(UPARAM(Required) FVoxelHeightSplineStampRef Stamp, UVoxelHeightSplineGraph*& Graph)
	{
		Graph = FVoxelUtilities::MakeSafe<UVoxelHeightSplineGraph*>();
	...
	static void SetGraph(UPARAM(Required) FVoxelHeightSplineStampRef Stamp, UPARAM(meta = (DisplayName = "Stamp")) FVoxelHeightSplineStampRef& OutStamp, UVoxelHeightSplineGraph* Graph)
	{
		OutStamp = Stamp;
