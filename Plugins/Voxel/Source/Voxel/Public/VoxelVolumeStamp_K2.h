...
public:
	...
	static FVoxelVolumeStampRef CastToVolumeStamp(const FVoxelStampRef Stamp, EVoxelStampCastResult& Result)
	{
	...
	static void MakeCopy(const FVoxelVolumeStampRef Stamp, FVoxelVolumeStampRef& Copy)
	{
	...
	static void GetLayer(UPARAM(Required) FVoxelVolumeStampRef Stamp, UVoxelVolumeLayer*& Layer)
	{
	...
	// You can control the order of layers in Layer Stacks
	// You can select the layer stack to use in your Voxel World or PCG Sampler settings
	UFUNCTION(BlueprintCallable, Category = "Voxel|Stamp|Volume", DisplayName = "Set Layer")
	static void SetLayer(UPARAM(Required) FVoxelVolumeStampRef Stamp, UPARAM(meta = (DisplayName = "Stamp")) FVoxelVolumeStampRef& OutStamp, UVoxelVolumeLayer* Layer)
	{
		OutStamp = Stamp;
	...
	static void GetBlendMode(UPARAM(Required) FVoxelVolumeStampRef Stamp, EVoxelVolumeBlendMode& BlendMode)
	{
	...
	static void SetBlendMode(UPARAM(Required) FVoxelVolumeStampRef Stamp, UPARAM(meta = (DisplayName = "Stamp")) FVoxelVolumeStampRef& OutStamp, EVoxelVolumeBlendMode BlendMode)
	{
		OutStamp = Stamp;
	...
	UFUNCTION(BlueprintPure, Category = "Voxel|Stamp|Volume", DisplayName = "Get Additional Layers")
	static void GetAdditionalLayers(UPARAM(Required) FVoxelVolumeStampRef Stamp, TArray<UVoxelVolumeLayer*>& AdditionalLayers)
	{
	...
	// This will automatically refresh the stamp
	UFUNCTION(BlueprintCallable, Category = "Voxel|Stamp|Volume", DisplayName = "Set Additional Layers")
	static void SetAdditionalLayers(UPARAM(Required) FVoxelVolumeStampRef Stamp, UPARAM(meta = (DisplayName = "Stamp")) FVoxelVolumeStampRef& OutStamp, TArray<UVoxelVolumeLayer*> AdditionalLayers)
	{
		OutStamp = Stamp;
