...
USTRUCT()
struct FVoxelPinValueOps_FVoxelHeightStampRef : public FVoxelPinValueOps
{
	GENERATED_BODY()
	...
	virtual void Fixup(FVoxelPinValueBase& Value) const override;

	virtual void CopyFrom(
		FVoxelPinValueBase& This,
		const FVoxelPinValueBase& Other) const override;
	//~ End FVoxelPinValueOps Interface
};

USTRUCT()
struct FVoxelPinValueOps_FVoxelVolumeStampRef : public FVoxelPinValueOps
{
	GENERATED_BODY()
	GENERATED_VIRTUAL_STRUCT_BODY()
