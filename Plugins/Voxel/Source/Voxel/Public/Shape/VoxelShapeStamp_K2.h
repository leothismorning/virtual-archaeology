...
public:
	...
	static FVoxelShapeStampRef CastToShapeStamp(const FVoxelStampRef Stamp, EVoxelStampCastResult& Result)
	{
	...
	static void MakeCopy(const FVoxelShapeStampRef Stamp, FVoxelShapeStampRef& Copy)
	{
	...
	static void GetSurfaceType(UPARAM(Required) FVoxelShapeStampRef Stamp, UVoxelSurfaceTypeInterface*& SurfaceType)
	{
	...
	static void SetSurfaceType(UPARAM(Required) FVoxelShapeStampRef Stamp, UPARAM(meta = (DisplayName = "Stamp")) FVoxelShapeStampRef& OutStamp, UVoxelSurfaceTypeInterface* SurfaceType)
	{
		OutStamp = Stamp;
