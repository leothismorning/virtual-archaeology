...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Misc", meta = (EditCondition = "bEnableTessellation", InlineEditConditionToggle))
	bool bEnableDisplacementFade = false;

	UPROPERTY(EditAnywhere, Category = "Misc", meta = (EditCondition = "bEnableDisplacementFade"))
