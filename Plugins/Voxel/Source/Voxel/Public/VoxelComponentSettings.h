...
#include "VoxelComponentSettings.generated.h"

USTRUCT(BlueprintType)
struct VOXEL_API FVoxelComponentSettings
{
	GENERATED_BODY()
...
public:
	...
	EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior = EShadowCacheInvalidationBehavior::Rigid;
...
public:
	...
	bool operator==(const FVoxelComponentSettings& Other) const;
};