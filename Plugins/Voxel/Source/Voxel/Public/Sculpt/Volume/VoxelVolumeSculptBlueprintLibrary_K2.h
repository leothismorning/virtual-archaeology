...
#include "VoxelVolumeSculptBlueprintLibrary.h"
...
UCLASS()
class VOXEL_API UVoxelVolumeSculptBlueprintLibrary_K2 : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
		...
		bool bCompress = true)
	{
		Voxel::ExecuteSynchronously([&]
		{
			return UVoxelVolumeSculptBlueprintLibrary::GetSave(
				Save,
				SculptActor,
				bCompress);
		});
