...
#include "VoxelHeightSculptBlueprintLibrary.h"
...
UCLASS()
class VOXEL_API UVoxelHeightSculptBlueprintLibrary_K2 : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
		...
		bool bCompress = true)
	{
		Voxel::ExecuteSynchronously([&]
		{
			return UVoxelHeightSculptBlueprintLibrary::GetSave(
				Save,
				SculptActor,
				bCompress);
		});
