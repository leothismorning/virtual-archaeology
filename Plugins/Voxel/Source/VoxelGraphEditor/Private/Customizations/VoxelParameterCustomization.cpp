...
VOXEL_CUSTOMIZE_STRUCT_CHILDREN(FVoxelParameter)(const TSharedRef<IPropertyHandle> PropertyHandle, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils)
{
	...
	const TVoxelArray<TVoxelObjectPtr<UVoxelGraph>> Graphs = FVoxelEditorUtilities::GetTypedOuters<UVoxelGraph>(PropertyHandle);
			...
			[
				...
				[
					...
					.Options_Lambda([=]()
					{
						...
						for (const TVoxelObjectPtr<UVoxelGraph>& WeakGraph : Graphs)
						{
