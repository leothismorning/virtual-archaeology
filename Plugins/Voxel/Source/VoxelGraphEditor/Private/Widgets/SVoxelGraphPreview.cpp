...
void SVoxelGraphPreview::SetTerminalGraph(UVoxelTerminalGraph* NewTerminalGraph)
{
	...
	GVoxelGraphTracker->OnEdGraphChanged(NewTerminalGraph->GetEdGraph()).Add(FOnVoxelGraphChanged::Make(OnEdGraphChangedPtr, this, [this]
	{
		bUpdateQueued = true;
	}));
...
void SVoxelGraphPreview::Update()
{
	...
	NewPreviewHandler->OnInvalidated = MakeWeakPtrLambda(this, MakeWeakPtrLambda(NewPreviewHandler, [this, &PreviewHandler = *NewPreviewHandler]
	{
		bUpdateQueued = true;
