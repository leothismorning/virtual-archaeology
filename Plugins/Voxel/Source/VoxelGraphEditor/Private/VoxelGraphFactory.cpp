...
UVoxelGraphFactory::UVoxelGraphFactory(const FObjectInitializer& ObjectInitializer)
...
UVoxelGraphBaseFactory::UVoxelGraphBaseFactory(const FObjectInitializer& ObjectInitializer)
{
	bCreateNew = true;
	bEditAfterNew = true;
}
