...
struct VOXELGRAPH_API FVoxelNode_ArrayLength : public FVoxelNode
{
	GENERATED_BODY()
...
struct VOXELGRAPH_API FVoxelNode_ArrayGetItem : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
struct VOXELGRAPH_API FVoxelNode_MakeArray : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
struct VOXELGRAPH_API FVoxelNode_AddToArray : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
...
USTRUCT(Category = "Array")
struct VOXELGRAPH_API FVoxelNode_AppendArray : public FVoxelNode
{
	GENERATED_BODY()
	GENERATED_VOXEL_NODE_BODY()
