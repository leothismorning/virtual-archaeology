...
#if WITH_EDITOR
class VOXELGRAPH_API IVoxelNodeDefinition : public TSharedFromThis<IVoxelNodeDefinition>
{
public:
	class FCategoryNode;
	class FVariadicPinNode;

	class VOXELGRAPH_API FNode : public TSharedFromThis<FNode>
	{
	public:
		enum class EType
		{
	...
	class VOXELGRAPH_API FVariadicPinNode : public FNode
	{
	public:
	...
	class VOXELGRAPH_API FCategoryNode : public FNode
	{
	public:
...
public:
	...
	virtual bool CanRenameSelectedPin(FName PinName) const { return false; }
	virtual bool IsNewPinNameValid(FName PinName, FName NewName) const { return true; }
	virtual void RenameSelectedPin(FName PinName, FName NewName) VOXEL_PURE_VIRTUAL();
	virtual bool ShouldPromptRenameOnSpawn(FName PinName) const { return false; }
